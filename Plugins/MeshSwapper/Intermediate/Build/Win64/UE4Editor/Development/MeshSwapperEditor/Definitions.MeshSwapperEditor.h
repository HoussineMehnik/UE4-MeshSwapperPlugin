...
#define UE_PROJECT_NAME MeshSwapperProject
#define UE_TARGET_NAME MeshAnimProjectEditor
...
#define MESHSWAPPER_API DLLIMPORT
...
#define MESHSWAPPEREDITOR_API DLLEXPORT
